/*
 * This used to be the script to send images to the paint_server.js.
 * TODO validate file and rewrite if this file is needed
 */
...
function sendData() {
    ...
    getPixels(src, function (err, pixels) {
        ...
        client.write(JSON.stringify(buf));
